...
func _run() -> void:
	...
	_assert(lines.size() == 4, "Setup local deberia mantener P1-P4 visibles.")
	...
	_assert(launch_config.local_slots.size() == 2, "Launch config deberia transportar solo slots activos.")
