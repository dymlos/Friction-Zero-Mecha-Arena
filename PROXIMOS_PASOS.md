...
6. **Validar la identidad del nuevo laboratorio FFA**
   ...
   - medir si el combo vivo `Marcador | ...` + `Posiciones | ...` + `Desempate | score igual -> mejor cierre de la ronda final` alcanza para explicar score y empates en FFA o si aun hace falta compactar/mejorar esa lectura cuando la ronda esta cargada.
