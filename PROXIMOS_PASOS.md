...
1. **Hacer visible y testeable el rescate/negacion**
   ...
   - medir en partida si `throw_pickup_delay`/`pickup_delay` se sienten justos o demasiado punitivos ahora que perder una ronda sí importa.
...
3. **Pulir la energia ahora que ya es jugable**
...
4. **Mejorar validacion jugable**
   - sumar una escena/configuración de prueba pensada para reproducir rescates, negaciones y cierres de ronda más rápido que en el match completo
...
5. **Preparar soporte Hard sin convertirlo en requisito**
