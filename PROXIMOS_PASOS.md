...
4. **Hacer visible y testeable el rescate/negacion**
   ...
   - medir si el nuevo combo `disco de recuperacion + aro de pertenencia + RecoveryTargetIndicator` realmente alcanza para leer urgencia/ownership/objetivo de retorno en 2v2 y FFA o si todavia hace falta una pista compacta adicional.
