...
- `support_payload_availability_readability_test.gd` ahora cubre además un caso diegético: con `interferencia`, dos rivales en rango y uno inmune por `estabilidad`, el target inicial sigue sobre el rival útil y, al ciclar al inmune, ambos marcadores bajan `emission_energy_multiplier`.
