...
- pendiente: decidir por playtest si la terna `estabilizador + energia + movilidad`, los `gates` temporales y el nuevo `StatusBeacon` ya alcanzan como fundamento legible o si la siguiente iteracion debe sumar mas variedad de rutas/obstaculos o una forma acotada de interferencia enemiga, sin volver la capa post-muerte demasiado ruidosa.
